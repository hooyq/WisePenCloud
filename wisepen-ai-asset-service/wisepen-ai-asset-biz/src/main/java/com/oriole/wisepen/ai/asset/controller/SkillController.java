...
public class SkillController {
    ...
    @Operation(
            ...
            description = """
                    ...
                    失败：当前用户不是资源所有者、技能不存在或字段校验失败时按统一异常返回。
                    响应：成功时返回空结果。
                    """
    )
    ...
    @Operation(
            ...
            description = """
                    ...
                    失败：资源无权限、技能不存在或资源服务调用失败时按统一异常返回。
                    响应：返回资源信息与技能资产信息。
                    """
    )
    ...
    @Operation(
            ...
            description = """
                    ...
                    失败：当前用户不是资源所有者、技能不存在或版本不存在时按统一异常返回。
                    响应：返回技能版本信息和资产文件元数据。
                    """
    )
    ...
    @Operation(
            ...
            description = """
                    ...
                    失败：当前用户不是资源所有者、版本不是草稿、主文件缺失或存在上传中的资产时按统一异常返回。
                    响应：成功时返回空结果。
                    """
    )
    ...
    @Operation(
            ...
            description = """
                    ...
                    失败：当前用户不是资源所有者、版本不是草稿、路径非法、存储上传凭证申请失败或字段校验失败时按统一异常返回。
    ...
    @Operation(
            ...
            description = """
                    ...
                    失败：当前用户不是资源所有者、版本不是草稿、字段校验失败或版本不存在时按统一异常返回。
                    响应：成功时返回空结果。
                    """
    )
