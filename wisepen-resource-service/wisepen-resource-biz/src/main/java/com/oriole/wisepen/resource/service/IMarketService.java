...
public interface IMarketService {
    ...
    MarketListingResponse listResource(MarketListResourceRequest request, Long sellerId, Map<Long, GroupRoleType> groupRoles);

    MarketListingResponse updateListingVersion(MarketUpdateListingVersionRequest request, Long sellerId);
    ...
    PageR<MarketListingResponse> listMarketListings(String marketGroupId, List<String> tagIds, int page, int size,
