...
public class ResourceTagController {
    ...
    @Operation(
            ...
            description = """
                    ...
                    失败：groupId 格式非法、当前用户不属于目标小组或标签读取失败时按统一异常返回。
                    响应：返回标签树根节点列表及其子节点。
                    """
    )
    ...
    @Operation(
            ...
            description = """
                    ...
                    失败：父节点不存在、同级重名、保留名称非法、回收站下创建或小组权限不足时按统一异常返回。
                    响应：返回新建标签 ID。
                    """
    )
    ...
    @Operation(
            ...
            description = """
                    ...
                    失败：标签不存在、系统标签被修改、个人标签设置权限、同级重名或小组权限不足时按统一异常返回。
                    响应：成功时返回空结果。
                    """
    )
    ...
    @Operation(
            ...
            description = """
                    ...
                    失败：目标标签或父标签不存在、形成环、跨类型移动、同级重名、系统标签被移动或小组权限不足时按统一异常返回。
                    响应：成功时返回空结果。
                    """
    )
    ...
    @Operation(
            ...
            description = """
                    ...
                    失败：标签不存在、系统标签被删除、路径标签直接删除或小组权限不足时按统一异常返回。
                    响应：成功时返回空结果。
                    """
    )
