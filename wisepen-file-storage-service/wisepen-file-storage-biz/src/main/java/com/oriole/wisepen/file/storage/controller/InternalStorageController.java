...
public class InternalStorageController {
    ...
    @Operation(
            ...
            description = """
                    ...
                    失败：存储配置不存在、对象存储生成凭证失败或记录写入失败时按统一异常返回。
    ...
    @Operation(
            ...
            description = """
                    ...
                    失败：文件记录不存在、文件仍未上传完成或存储服务生成下载地址失败时按统一异常返回。
                    响应：返回限时下载 URL。
                    """
    )
    ...
    @Operation(
            ...
            description = """
                    ...
                    失败：存储配置不存在、场景非法或云厂商凭证申请失败时按统一异常返回。
                    响应：返回临时访问凭证及其有效期信息。
                    """
    )
    ...
    @Operation(
            ...
            description = """
                    ...
                    失败：没有匹配到可删除文件记录或数据库更新失败时按统一异常返回。
                    响应：成功时返回空结果。
                    """
    )
